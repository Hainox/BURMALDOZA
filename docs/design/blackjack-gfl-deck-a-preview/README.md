...
**[Открыть интерактивное превью на GitHub Pages](https://hainox.github.io/BURMALDOZA/design/blackjack-deck-a/)** — поиск по имени, фильтры по масти и номиналу, досье карты по нажатию.
