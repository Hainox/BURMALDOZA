...
Ниже — статичные контактные листы Deck A из раннего концепта комнаты. Они показывают состав, но не актуальный фон сцены. В интерактивном превью можно сравнить обе колоды и увидеть текущий концепт заброшенного здания; каждая колода содержит 52 карты. Deck B включает 51 найденный портрет и помеченный placeholder для PTRS.
