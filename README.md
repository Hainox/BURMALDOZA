...
Интерактивный пилот показывает предполагаемый интерфейс: виртуальный баланс, выбор цвета и количества жетонов, анимацию, результат и историю. Его можно открыть по адресу **https://hainox.github.io/BURMALDOZA/**. Для локального запуска достаточно Python — Node.js, Docker и Telegram-аккаунт не нужны.
...
- Результат задан сценарием и зависит от выбранного цвета. Это не случайная рулетка и не модель вероятностей будущей игры.
